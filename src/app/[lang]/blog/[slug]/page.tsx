      ...
      <main className="flex-1 px-6 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <div className="flex items-center gap-3 pt-5 border-t border-themed">
          ...
          <div className="border-t border-themed pt-10">
            {dynamicPost ? (
          ...
          <div className="mt-12 pt-8 border-t border-themed flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
            <Link
              href={`/${lang}/blog`}

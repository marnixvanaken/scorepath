      ...
      <header className="shrink-0 px-5 py-4 border-b border-[#141414] flex items-center justify-between">
        <AnimatePresence mode="wait">
          {step === 1 ? (
            ...
            >
              <Link href="/" aria-label="Terug naar home">
                <Logo size="sm" />
              </Link>
            </motion.div>
          ) : (
        ...
        {/* Step indicator */}
        <div className="flex items-center gap-1.5" aria-label={`Stap ${step} van 2`}>
          {([1, 2] as Step[]).map((s) => (
            <div
              key={s}
              ...
              <div className="max-w-lg mx-auto w-full">
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="font-black text-xl text-white mb-1">FIFA World Cup 2026</p>
                    <p className="text-slate-500 text-sm">48 teams · 12 groepen · USA / Canada / Mexico</p>
                  </div>
            ...
            >
              <div className="max-w-lg mx-auto w-full">
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-black text-white text-lg mb-1.5">Snel invullen</p>
                        <p className="text-slate-500 text-sm leading-relaxed">
                          Kies per wedstrijd win, gelijk of verlies. Snel en makkelijk op mobiel.
                        </p>
                      </div>
                      <svg
                        className="shrink-0 mt-1 text-slate-700 group-hover:text-orange-500 transition-colors"
                        width="18"
                        height="18"
                        viewBox="0 0 24 24"
                        fill="none"
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-black text-white text-lg mb-1.5">Exacte uitslagen</p>
                        <p className="text-slate-500 text-sm leading-relaxed">
                          Vul per wedstrijd de exacte score in. Nauwkeurigere doelpuntenstanden.
                        </p>
                      </div>
                      <svg
                        className="shrink-0 mt-1 text-slate-700 group-hover:text-orange-500 transition-colors"
                ...
                <p className="text-center text-xs text-slate-700 mt-6">
                  Je kunt dit later altijd wisselen via de knop bovenaan
                </p>
              </div>
            </motion.div>
          )}

...
export const NL: Messages = {
  ...
  home: {
    ...
    openBirthplace: 'OPEN ZOEKER',
    birthplaceEyebrow: 'Geboorteplaats-checker',
    wcEyebrow: 'WK 2026',
    wcTitle: 'Speel het WK 2026 helemaal na',
    wcDesc: 'Vul alle 104 wedstrijden in, zie met de echte FIFA-regels wie doorgaat en deel je bracket via één link.',
    ...
    openUcl: 'OPEN LOTING',
    globeEyebrow: 'Nieuw · Wereldwijd',
    globeTitle: 'Ontdek clubs op de globe',
    globeDesc: 'Draai over de wereldbol, klik op een club en bekijk het stadion, komende wedstrijden en plan direct je voetbaltrip.',
    openGlobe: 'OPEN DE GLOBE',
  },
  start: {
  ...
  birthplace: {
    ...
    topN: 'Top 10 dichtstbijzijnde spelers',
    distanceKm: 'km',
    showTopN: 'Toon top 10 op kaart',
    hideTopN: 'Verberg top 10',
    posGK: 'Keeper',
    posDF: 'Verdediger',
    posMF: 'Middenvelder',
    posFW: 'Aanvaller',
  ...
  globe: {
    title: 'Clubs wereldwijd',
    subtitle: 'Draai en zoom over de wereldbol, klik op een club en ontdek het stadion, komende wedstrijden en jouw volgende voetbaltrip.',
    loading: 'Globe laden...',
    tierLabel: 'Niveau',
    tierAll: 'Alle',
    tier1: '1e niveau',
    ...
    capAny: 'Alle',
    competitionLabel: 'Competitie',
    compAll: 'Alle competities',
    uefaLabel: 'Europees',
    uefaAll: 'Alle',
    clubsShown: '{n} clubs',
    ...
    ctaTickets: 'Tickets zoeken',
    ctaHotels: 'Hotels bij het stadion',
    ctaTrip: 'Plan je groundhop',
    affiliateDisclosure: 'Sommige links zijn affiliate-links: boek je erlangs, dan steun je Scorepath.',
    close: 'Sluiten',
    resetFilters: 'Reset filters',
    webglTitle: 'Globe niet beschikbaar',
    webglDesc: 'Je browser ondersteunt geen WebGL. Blader hieronder door alle clubs.',
    listTitle: 'Alle clubs',
    globeHint: 'Interactieve wereldbol met voetbalclubs. Sleep om te draaien, scroll om te zoomen en klik op een club voor meer informatie.',
  },
  ogCard: {
